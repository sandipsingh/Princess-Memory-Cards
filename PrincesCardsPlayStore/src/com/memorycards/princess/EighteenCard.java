...
public class EighteenCard extends Activity implements OnClickListener {
 RelativeLayout rr;
	 SharedPreferences myPrefs;
	private AdView ad; 
	private MediaPlayer mediaPlayer1, mediaPlayer2, mediaPlayer3;
	private TextView tv;
	private int count1=0,count2=0,count3=0,count4=0,count5=0,count6=0,count7=0,count8=0,count9=0,success1=0;
  ...
  private Button button_next;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eighteen_card);
...
//		mediaPlayer3=MediaPlayer.create(MemoryCard2.this, R.raw.correct); 
		...
		if (j == 0) {
			...
			i21.setTag("Pocahontus");
			i22.setImageBitmap(bm11);
			i22.setTag("Rapunzel");
		
			i23.setImageBitmap(bm11);
			i23.setTag("Rapunzel");
			i24.setImageBitmap(bm10);
			i24.setTag("Pocahontus");
...
//		});
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				EighteenCard.this.startActivity(new Intent(EighteenCard.this,Splash.class));
				EighteenCard.this.finish();
	...
	public void rotate() {
		...
		rl16 = (RelativeLayout) findViewById(R.id.m15);
		rl17 = (RelativeLayout) findViewById(R.id.m15);
		rl18 = (RelativeLayout) findViewById(R.id.m15);
		
		final Animation a = AnimationUtils.loadAnimation(EighteenCard.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(EighteenCard.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 8:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(EighteenCard.this);
			        ...
			        next.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							EighteenCard.this.finish();
							EighteenCard.this.startActivity(new Intent(EighteenCard.this,TwentyCard.class));
						}
					});
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							EighteenCard.this.finish();
							EighteenCard.this.startActivity(new Intent(EighteenCard.this,EighteenCard.class));        
						}
					});
					...
					dialog.show();
					myPrefs = EighteenCard.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
			           SharedPreferences.Editor prefsEditor = myPrefs.edit();
			           prefsEditor.putString("level12",tv.getText().toString());
			           prefsEditor.commit();
				default:             
					break;                   
				}
	...
	private void initiallizeMediaPlayer(int which) {
		switch (which) {
		case 1:
			mediaPlayer1 = MediaPlayer.create(EighteenCard.this, R.raw.pop); 
			break;
		case 2:
			mediaPlayer2 = MediaPlayer.create(EighteenCard.this, R.raw.trumpet);
			break;
		case 3:
			mediaPlayer3 = MediaPlayer.create(EighteenCard.this, R.raw.correct);
			break;
		default:
			break;
		}
