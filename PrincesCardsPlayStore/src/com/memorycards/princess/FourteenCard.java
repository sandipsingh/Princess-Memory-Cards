...
public class FourteenCard extends Activity implements OnClickListener {
 RelativeLayout rr;
  ...
  private Button button_next;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fourteen_card);
...
//		i24.setVisibility(View.GONE);
	...
	//	i11.setOnClickListener(this);
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				FourteenCard.this.startActivity(new Intent(FourteenCard.this,Splash.class));
				FourteenCard.this.finish();
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(FourteenCard.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(FourteenCard.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 8:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(FourteenCard.this);
			        ...
			        next.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							FourteenCard.this.finish();
							FourteenCard.this.startActivity(new Intent(FourteenCard.this,SixteenCards.class));
						}
					});
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							FourteenCard.this.finish();
							FourteenCard.this.startActivity(new Intent(FourteenCard.this,FourteenCard.class));        
						}
					});
					...
					dialog.show();
					myPrefs = FourteenCard.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
	...
	private void initiallizeMediaPlayer(int which) {
		switch (which) {
		case 1:
			mediaPlayer1 = MediaPlayer.create(FourteenCard.this, R.raw.pop); 
			break;
		case 2:
			mediaPlayer2 = MediaPlayer.create(FourteenCard.this, R.raw.trumpet);
			break;
		case 3:
			mediaPlayer3 = MediaPlayer.create(FourteenCard.this, R.raw.correct);
			break;
		default:
			break;
		}
