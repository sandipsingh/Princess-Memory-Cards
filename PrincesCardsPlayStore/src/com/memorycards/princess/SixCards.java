...
public class SixCards extends Activity implements OnClickListener {
	RelativeLayout rr;
...
//		mediaPlayer1=MediaPlayer.create(SixCards.this, R.raw.pop);    
//        mediaPlayer2=MediaPlayer.create(SixCards.this, R.raw.trumpet); 
//		mediaPlayer3=MediaPlayer.create(SixCards.this, R.raw.correct); 
      ...
      tv=(TextView)findViewById(R.id.textView1);
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				SixCards.this.startActivity(new Intent(SixCards.this,Splash.class));
				SixCards.this.finish();
			}
	...
	public void rotate() {
		...
		Animation a = AnimationUtils.loadAnimation(SixCards.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {      
		...
		Animation a = AnimationUtils.loadAnimation(SixCards.this,R.anim.shake);   
		a.setDuration(500);
			...
			public void handleMessage(Message msg) { 
				...
				case 8:
                  ...
                  case 9:
                	  ...
                	  final Dialog dialog = new Dialog(SixCards.this);
				        ...
				        next.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 SixCards.this.finish();
								  SixCards.this.startActivity(new Intent(SixCards.this,SixCards1.class));
							}
						});
				        restart.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 SixCards.this.finish();
								  SixCards.this.startActivity(new Intent(SixCards.this,SixCards.class));  
							}
						});
						...
						dialog.show();
						myPrefs = SixCards.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
				           SharedPreferences.Editor prefsEditor = myPrefs.edit();
				           prefsEditor.putString("level3",tv.getText().toString());
				           prefsEditor.commit();
				default:
					break;        
				}
