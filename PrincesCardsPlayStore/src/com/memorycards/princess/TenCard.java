...
public class TenCard extends Activity implements OnClickListener {
 RelativeLayout rr;
...
//	
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				TenCard.this.startActivity(new Intent(TenCard.this,Splash.class));
				TenCard.this.finish();
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(TenCard.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(TenCard.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 8:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(TenCard.this);
			        ...
			        next.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							TenCard.this.finish();
							TenCard.this.startActivity(new Intent(TenCard.this,MemoryCard1.class));
						}
					});
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							TenCard.this.finish();
							TenCard.this.startActivity(new Intent(TenCard.this,TenCard.class));        
						}
					});
					...
					dialog.show();
					myPrefs = TenCard.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
			           SharedPreferences.Editor prefsEditor = myPrefs.edit();
			           prefsEditor.putString("level7",tv.getText().toString());
			           prefsEditor.commit();
				default:             
					break;                   
				}
...
//		i11.setClickable(state);     
	...
	private void initiallizeMediaPlayer(int which) {
		switch (which) {
		case 1:
			mediaPlayer1 = MediaPlayer.create(TenCard.this, R.raw.pop); 
			break;
		case 2:
			mediaPlayer2 = MediaPlayer.create(TenCard.this, R.raw.trumpet);
			break;
		case 3:
			mediaPlayer3 = MediaPlayer.create(TenCard.this, R.raw.correct);
			break;
		default:
			break;
		}
