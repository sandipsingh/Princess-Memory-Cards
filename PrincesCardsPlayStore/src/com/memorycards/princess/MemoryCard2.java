...
public class MemoryCard2 extends Activity implements OnClickListener {
 RelativeLayout rr;
...
//		});
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				MemoryCard2.this.startActivity(new Intent(MemoryCard2.this,Splash.class));
				MemoryCard2.this.finish();
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(MemoryCard2.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(MemoryCard2.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 8:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(MemoryCard2.this);
			        ...
			        next.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							MemoryCard2.this.finish();
							MemoryCard2.this.startActivity(new Intent(MemoryCard2.this,FourteenCard.class));
						}
					});
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							MemoryCard2.this.finish();
							MemoryCard2.this.startActivity(new Intent(MemoryCard2.this,MemoryCard2.class));        
						}
					});
					...
					dialog.show();
					myPrefs = MemoryCard2.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
			           SharedPreferences.Editor prefsEditor = myPrefs.edit();
			           prefsEditor.putString("level9",tv.getText().toString());
			           prefsEditor.commit();
				default:             
					break;                   
				}
