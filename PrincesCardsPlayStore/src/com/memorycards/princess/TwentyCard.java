...
public class TwentyCard extends Activity implements OnClickListener {
 RelativeLayout rr;
	 SharedPreferences myPrefs;
	private AdView ad; 
	private MediaPlayer mediaPlayer1, mediaPlayer2, mediaPlayer3;
	private TextView tv;
	private int count1=0,count2=0,count3=0,count4=0,count5=0,count6=0,count7=0,count8=0,count9=0,count10=0,success1=0;
	...
	private ImageView i, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12,
			...
			i26,myim, ii1, ii2, ii3, ii4, ii5, ii6, ii7, ii8, ii9,  iii1,iii2,iii3, iii4, iii5, iii6, iii7, iii8, iii9;
	private Intent in;
	...
	private RelativeLayout rl, rl1, rl2, rl3, rl4, rl5, rl6, rl7, rl8, rl9,
			rl10, rl11, rl13, rl14, rl15, rl16, rl17, rl18, rl19, rl20, rl21;
	private String g, h;
  ...
  private Button button_next;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.twenty_card);
...
//		mediaPlayer3=MediaPlayer.create(MemoryCard2.this, R.raw.correct); 
		...
		if (j == 0) {
			...
			i25.setImageBitmap(bm12);
			i25.setTag("Snow-White");
			ii1.setImageBitmap(bm11);
			ii1.setTag("Rapunzel");
			...
			ii6.setTag("Aurora");
			ii7.setImageBitmap(bm5);
			ii7.setTag("Belle");
			ii8.setImageBitmap(bm4);
			ii8.setTag("Baby-belle");
			ii9.setImageBitmap(bm3);
			ii9.setTag("Meldoy");
		}
		if (j == 1) {
			...
			i24.setImageBitmap(bm3);
			i24.setTag("Meldoy");
			
			i25.setImageBitmap(bm3);
			i25.setTag("Meldoy");
			ii1.setImageBitmap(bm12);
			ii1.setTag("Snow-White");
			ii2.setImageBitmap(bm11);
			ii2.setTag("Rapunzel");
			...
			ii6.setTag("Zelda");
			ii7.setImageBitmap(bm6);
			ii7.setTag("Aurora");
			ii8.setImageBitmap(bm5);
			ii8.setTag("Belle");
			ii9.setImageBitmap(bm4);
			ii9.setTag("Baby-belle");
		}
		if (j == 2) {
		...
		if (j == 4) {
			...
			ii4.setTag("Meldoy");
			ii5.setImageBitmap(bm12);
			ii5.setTag("Snow-White");
			ii6.setImageBitmap(bm11);
			ii6.setTag("Rapunzel");
			ii7.setImageBitmap(bm10);
			ii7.setTag("Pocahontus");
			ii8.setImageBitmap(bm9);
			ii8.setTag("Magera");
			ii9.setImageBitmap(bm8);
			ii9.setTag("Eilonway");
		}
		if (j == 5) {
...
//		i21.setVisibility(View.GONE);
	...
	//	i8.setOnClickListener(this);
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				TwentyCard.this.startActivity(new Intent(TwentyCard.this,Splash.class));
				TwentyCard.this.finish();
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(TwentyCard.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(TwentyCard.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 13:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(TwentyCard.this);
			        ...
			        next.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							TwentyCard.this.finish();
							TwentyCard.this.startActivity(new Intent(TwentyCard.this,TwentyTwo.class));
						}
					});
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							TwentyCard.this.finish();
							TwentyCard.this.startActivity(new Intent(TwentyCard.this,TwentyCard.class));        
						}
					});
					...
					dialog.show();
					myPrefs = TwentyCard.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
			           SharedPreferences.Editor prefsEditor = myPrefs.edit();
			           prefsEditor.putString("level13",tv.getText().toString());
			           prefsEditor.commit();
				default:             
					break;                   
				}
	...
	private void initiallizeMediaPlayer(int which) {
		switch (which) {
		case 1:
			mediaPlayer1 = MediaPlayer.create(TwentyCard.this, R.raw.pop); 
			break;
		case 2:
			mediaPlayer2 = MediaPlayer.create(TwentyCard.this, R.raw.trumpet);
			break;
		case 3:
			mediaPlayer3 = MediaPlayer.create(TwentyCard.this, R.raw.correct);
			break;
		default:
			break;
		}
