...
public class EightCards extends Activity implements OnClickListener {
	RelativeLayout rr;
...
//		mediaPlayer1=MediaPlayer.create(EightCards.this, R.raw.pop);    
//	    mediaPlayer2=MediaPlayer.create(EightCards.this, R.raw.trumpet);  
//		mediaPlayer3=MediaPlayer.create(EightCards.this, R.raw.correct); 
		...
		rr = (RelativeLayout) findViewById(R.id.relative_home); 
		 ...
		 String id = "a1500d017994319";
			ad = new AdView(this, AdSize.SMART_BANNER, id);	 rr.addView(ad);
...
//		});
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				EightCards.this.startActivity(new Intent(EightCards.this,Splash.class));
				EightCards.this.finish();
...
//	}
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(EightCards.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(EightCards.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 8:
					...
					break;
				case 9:
					 final Dialog dialog = new Dialog(EightCards.this);
				        ...
				        next.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 EightCards.this.finish();
								  EightCards.this.startActivity(new Intent(EightCards.this,EightCards1.class));
							}
						});
				        restart.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 EightCards.this.finish();
								  EightCards.this.startActivity(new Intent(EightCards.this,EightCards.class));   
							}
						});
						...
						dialog.show();
						 myPrefs = EightCards.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
				           SharedPreferences.Editor prefsEditor = myPrefs.edit();
				           prefsEditor.putString("level5",tv.getText().toString());
				           prefsEditor.commit();
				default:             
					break;                   
				}
