...
public class FourCards extends Activity implements OnClickListener {
RelativeLayout rr;
	...
	rr = (RelativeLayout) findViewById(R.id.relative_home);
		...
		Button btn=(Button) findViewById(R.id.imageView29);
...
//		mediaPlayer1 = MediaPlayer.create(FourCards.this, R.raw.pop);   
//		mediaPlayer2 = MediaPlayer.create(FourCards.this, R.raw.trumpet);
//		mediaPlayer3 = MediaPlayer.create(FourCards.this, R.raw.correct);
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				FourCards.this.startActivity(new Intent(FourCards.this,
						Splash.class));
				FourCards.this.finish();
			}
	...
	public void compare(Object a, Object b, Object c, Object d) {
		...
		if (a == b) {
			...
			if (e == "Fairy-Ballerina" && b == "Fairy-Ballerina") {
				System.out.println("Fairy-Ballerina");
	...
	public void rotate() {
		...
		Animation a = AnimationUtils.loadAnimation(FourCards.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils
				.loadAnimation(FourCards.this, R.anim.shake);
		a.setDuration(500);
		...
		hRefresh = new Handler() {
			public void handleMessage(Message msg) {
				...
				case 9:
					 ...
					 final Dialog dialog = new Dialog(FourCards.this);
				        ...
				        next.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 FourCards.this.finish();
								  FourCards.this.startActivity(new Intent(FourCards.this,FourCards1.class));
							}
						});
				        restart.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 FourCards.this.finish();
								  FourCards.this.startActivity(new Intent(FourCards.this,FourCards.class));  
							}
						});
						...
						dialog.show();
						myPrefs = FourCards.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
				           SharedPreferences.Editor prefsEditor = myPrefs.edit();
				           prefsEditor.putString("level1",tv.getText().toString());
				           prefsEditor.commit();
					break;
				default:
					break;
