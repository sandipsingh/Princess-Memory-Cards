...
public class MemoryCard1 extends Activity implements OnClickListener {
 RelativeLayout rr;
...
//		});
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				MemoryCard1.this.startActivity(new Intent(MemoryCard1.this,Splash.class));
				MemoryCard1.this.finish();
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(MemoryCard1.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(MemoryCard1.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 8:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(MemoryCard1.this);
			        ...
			        next.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							MemoryCard1.this.finish();
							MemoryCard1.this.startActivity(new Intent(MemoryCard1.this,MemoryCard2.class));
						}
					});
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							MemoryCard1.this.finish();
							MemoryCard1.this.startActivity(new Intent(MemoryCard1.this,MemoryCard1.class));        
						}
					});
					...
					dialog.show();
					myPrefs = MemoryCard1.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
			           SharedPreferences.Editor prefsEditor = myPrefs.edit();
			           prefsEditor.putString("level8",tv.getText().toString());
			           prefsEditor.commit();
				default:             
					break;                   
				}
	...
	private void initiallizeMediaPlayer(int which) {
		switch (which) {
		case 1:
			mediaPlayer1 = MediaPlayer.create(MemoryCard1.this, R.raw.pop); 
			break;
		case 2:
			mediaPlayer2 = MediaPlayer.create(MemoryCard1.this, R.raw.trumpet);
			break;
		case 3:
			mediaPlayer3 = MediaPlayer.create(MemoryCard1.this, R.raw.correct);
			break;
		default:
			break;
		}
