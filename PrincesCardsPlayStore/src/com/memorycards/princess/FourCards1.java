...
public class FourCards1 extends Activity implements OnClickListener {
	RelativeLayout rr;
   ...
   private TextView tv;
	...
	public void onCreate(Bundle savedInstanceState) {           
		...
		setContentView(R.layout.four_cards1);
...
//		mediaPlayer1=MediaPlayer.create(FourCards1.this, R.raw.pop);    
//        mediaPlayer2=MediaPlayer.create(FourCards1.this, R.raw.trumpet); 
//		mediaPlayer3=MediaPlayer.create(FourCards1.this, R.raw.correct); 
      tv=(TextView)findViewById(R.id.textView1);
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				FourCards1.this.startActivity(new Intent(FourCards1.this,Splash.class));
				FourCards1.this.finish();  
			}
	...
	public void rotate() {
		...
		Animation a = AnimationUtils.loadAnimation(FourCards1.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(FourCards1.this,R.anim.shake);   
		a.setDuration(500);
			...
			public void handleMessage(Message msg) { 
				...
				case 8:
                   ...
                   case 9:
                	   ...
                	   final Dialog dialog = new Dialog(FourCards1.this);
				        ...
				        next.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 FourCards1.this.finish();
								  FourCards1.this.startActivity(new Intent(FourCards1.this,SixCards.class));
							}
						});
				        restart.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								// TODO Auto-generated method stub
								 FourCards1.this.finish();
								  FourCards1.this.startActivity(new Intent(FourCards1.this,FourCards1.class));  
							}
						});
						...
						dialog.show();
						myPrefs = FourCards1.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
				           SharedPreferences.Editor prefsEditor = myPrefs.edit();
				           prefsEditor.putString("level2",tv.getText().toString());
				           prefsEditor.commit();      
				default:
					break;        
				}
