...
public class TwentyFour extends Activity implements OnClickListener {
 RelativeLayout rr;
  ...
  private Button button_next;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bm14=  BitmapFactory.decodeResource(getResources(), R.drawable.memmm6);//Fairy-Ballerina
...
//		mediaPlayer3=MediaPlayer.create(MemoryCard2.this, R.raw.correct); 
		...
		if (j == 0) {
			...
			i25.setTag("Fairy-Ballerina");
		
			ii1.setImageBitmap(bm14);
			ii1.setTag("Fairy-Ballerina");
			ii2.setImageBitmap(bm13);
			ii2.setTag("Cinderella");
		...
		if (j == 1) {
			...
			i22.setTag("Snow-White");
			i23.setImageBitmap(bm13);
			i23.setTag("Cinderella");
			i24.setImageBitmap(bm14);
			i24.setTag("Fairy-Ballerina");
		...
		if (j == 2) {
			...
			i21.setTag("Cinderella");
			i22.setImageBitmap(bm14);
			i22.setTag("Fairy-Ballerina");
...
//		});
		...
		i13.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				TwentyFour.this.startActivity(new Intent(TwentyFour.this,Splash.class));
	...
	public void rotate() {
		...
		final Animation a = AnimationUtils.loadAnimation(TwentyFour.this,
				R.anim.rotate);
		a.setDuration(2000);
	...
	public void shake() {
		...
		Animation a = AnimationUtils.loadAnimation(TwentyFour.this,
				R.anim.shake);
		a.setDuration(500);
		 ...
		 hRefresh = new Handler() {
			public void handleMessage(Message msg) { 
				...
				case 15:
					...
					break;
				case 9:
					final Dialog dialog = new Dialog(TwentyFour.this);
			        ...
			        restart.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							TwentyFour.this.finish();
							TwentyFour.this.startActivity(new Intent(TwentyFour.this,TwentyFour.class));        
						}
					});
					...
					dialog.show();
					myPrefs = TwentyFour.this.getSharedPreferences("hello", MODE_WORLD_READABLE);
	...
	private void initiallizeMediaPlayer(int which) {
		switch (which) {
		case 1:
			mediaPlayer1 = MediaPlayer.create(TwentyFour.this, R.raw.pop); 
			break;
		case 2:
			mediaPlayer2 = MediaPlayer.create(TwentyFour.this, R.raw.trumpet);
			break;
		case 3:
			mediaPlayer3 = MediaPlayer.create(TwentyFour.this, R.raw.correct);
			break;
		default:
			break;
		}
